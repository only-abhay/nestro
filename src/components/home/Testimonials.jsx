export default function TestimonialSection() {
  ...
  return (
    <section className="max-w-full px-6 pb-10 ">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {testimonials.map((item, index) => (
          <div
            key={index}
            className="bg-white border border-[#E8E0D5] rounded-2xl p-6 hover:shadow-lg transition-all duration-300"
          >
            ...
            <p className="text-gray-600 leading-7 text-[12px] mb-3">
              "{item.text}"
            </p>

            <div className="flex items-center gap-4">

              <div className="w-8 h-8 rounded-full bg-[#C6A27E] text-white flex items-center justify-center text-[12px] font-semibold">
                {item.initials}
              </div>
