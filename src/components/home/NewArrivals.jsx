    ...
    <section className="max-w-full  px-6 py-16">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <h2 className="text-3xl font-semibold text-[#2C2016]">
            Just Landed
          </h2>
        </div>

        <button className="text-[#8B5E3C] font-medium hover:text-[#C6A27E] transition">
          View All
        </button>
      </div>
      ...
      <div className="grid lg:grid-cols-[1.8fr_1fr_1fr] gap-4">

        {/* Featured Product */}

        <div className="bg-[#2C2016] rounded-2xl p-7 pb-0 overflow-hidden">

          <span className="uppercase tracking-[3px] text-[#C6A27E] text-[10px] block mb-3">
            Featured
          </span>

          <h3 className="text-[18px] text-white leading-tight mb-3">
            Scandinavian
            <br />
            Dining Set
          </h3>
          ...
          <div className="mt-8 h-20 rounded-xl bg-[#C6A27E]/10 flex items-center justify-center">
            <Image
          ...
          <button className="bg-[#C6A27E] text-white px-5 py-3 rounded-full text-sm hover:bg-[#b28c67] transition">
            View in Store
          </button>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-white rounded-2xl border border-[#E8E0D5] overflow-hidden hover:shadow-lg transition">
            ...
            <div className="h-20 bg-[#F5F0EB] relative">
              <Image
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-[#F5EDE4] border border-[#E8E0D5] rounded-2xl p-5">
            ...
            <button className="bg-[#C6A27E] text-white px-4 py-2 rounded-full text-sm hover:bg-[#b28c67] transition">
              Shop Now
            </button>
          ...
          <div className="bg-white border border-[#E8E0D5] rounded-2xl p-5 flex-1">
            ...
            <div className="mt-5 text-[#C6A27E]">
              <Truck size={32} />
            </div>
