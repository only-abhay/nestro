...
export default function StoreHero() {
  return (
    <section className="relative mx-6 my-5 overflow-hidden rounded-2xl  bg-[linear-gradient(135deg,_#2C2016_0%,_#3D2B1A_60%,_#5A3D24_100%)]">
      ...
      <div className="relative  grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex justify-center lg:justify-end">
          <div className="relative w-full max-w-[520px] rounded-3xl bg-gradient-to-br from-[#D6BFA7]/60 via-[#C6A27E]/30 to-[#8B5E3C]/20 border border-[#E8E0D5] shadow-xl" />

          {/* Extra Glow */}
          <div className="absolute w-[400px] bg-[#C6A27E]/20 blur-3xl rounded-full -z-10 right-0 top-1/2 -translate-y-1/2" />
        </div>
